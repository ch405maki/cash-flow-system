...
const isSalary = props.isSalary || false;
                    ...
                    <table class="w-full text-sm border border-border rounded-md">
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="p-2">{{ formattedDate(voucher.voucher_date) }}</td>
                            </tr>
                            <tr class="border-b">
                                ...
                                <td class="p-2">{{ voucher.check_amount }}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="w-full text-sm border border-border rounded-md">
                        <tbody>
                            <tr class="border-b">
                                ...
                                <td class="p-2">{{ formattedDate(voucher.check_date) }}</td>
                            </tr>
                            <tr>
                    ...
                    <table class="w-full text-sm border border-border rounded-md">
                        <tbody>
                            <tr class="border-b">
                                ...
                                <td class="p-2 border-r">{{ formattedDate(voucher.issue_date) }}</td>
                                <td class="p-2 font-medium text-muted-foreground border-r">PAYMENT DATE:</td>
                                <td class="p-2">{{ formattedDate(voucher.payment_date) }}</td>
                            </tr>
                            <tr>
                                <td class="p-2 font-medium text-muted-foreground border-r">DELIVERY DATE:</td>
                                <td class="p-2" colspan="3">{{ formattedDate(voucher.delivery_date) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <template v-if="isSalary">
                        ...
                        <tbody>
                            <tr v-for="detail in voucher.details" :key="detail.id">
                                <td style="text-align: left;">{{ accounts.find(a => a.id === detail.account_id)?.account_title || 'N/A' }}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td style="text-align: right; border: 1px solid black; padding: 5px; font-weight: bold;">
                                    ₱{{ voucher.details.reduce((sum, detail) => sum + detail.amount, 0).toFixed(2) }}
                                </td>
                            </tr>
                        </tfoot>
                    </template>
                ...
                <table>
                    <tr>
                        ...
                        <td width="50%" style="vertical-align: top;">
                            ...
                            <strong>{{ amountToWords(voucher.check_amount) }} </strong>
