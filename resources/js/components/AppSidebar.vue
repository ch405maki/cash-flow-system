        ...
        [
            {
                ...
                children: [
                    ...
                    { title: 'On Process', href: '/request?pageType=to-receive' },
                    { title: 'Completed', href: '/request?pageType=released' },
                    { title: 'Rejected', href: '/request?pageType=rejected' },
                ],
            },
        ],
        'staffRequests',
        ...
        [
            {
                ...
                icon: BarChart3,
                isOpen: false,
                children: [{ title: 'Petty Cash Summary', href: '/reports/petty-cash' }],
            },
        ],
        'bursarReports',
    ),
        ...
        [
            {
                ...
                icon: BarChart3,
                isOpen: false,
                children: [{ title: 'Purchase Order Summary', href: '/reports/po-summary' }],
            },
        ],
        'purchasingReports',
    ),
        ...
        <SidebarContent>
            ...
            <div v-if="user?.role === 'executive_director'">
                ...
                <div v-if="user?.is_petty_cash === 1">
                    <NavMain :items="pettyCashNavItems" group-label="Petty Cash" group-id="pettyCash" @update:state="handleStateUpdate" />
                </div>
                <NavMain :items="reportItems" group-label="Reports" group-id="reports" @update:state="handleStateUpdate" />
            </div>
            ...
            <div v-if="user?.role === 'accounting'">
                ...
                <NavMain :items="staffRequestItems" group-label="Request" group-id="staffRequests" @update:state="handleStateUpdate" />
                <NavMain :items="reportItems" group-label="Reports" group-id="reports" @update:state="handleStateUpdate" />
            </div>
            ...
            <div v-if="user?.role === 'bursar'">
                ...
                <NavMain :items="staffRequestItems" group-label="Request" group-id="staffRequests" @update:state="handleStateUpdate" />
                <NavMain :items="bursarReportItems" group-label="Reports" group-id="bursarReports" @update:state="handleStateUpdate" />
            </div>
            ...
            <div v-if="user?.role === 'property_custodian'">
                ...
                <NavMain :items="custodianReportItems" group-label="Reports" group-id="custodianReports" @update:state="handleStateUpdate" />
            </div>

            <div v-if="user?.role === 'purchasing'">
                <NavMain :items="purchasingNavItems" group-label="Navigation" />
                <NavMain :items="purchasingCanvasNavItems" group-label="Transaction" group-id="purchasingCanvas" @update:state="handleStateUpdate" />
                <NavMain :items="purchasingPONavItems" group-id="purchasingPO" @update:state="handleStateUpdate" />
                <div v-if="user?.is_petty_cash === 1">
                    <NavMain :items="pettyCashNavItems" group-label="Petty Cash" group-id="pettyCash" @update:state="handleStateUpdate" />
                </div>
                <NavMain :items="purchasingReportItems" group-label="Reports" group-id="purchasingReports" @update:state="handleStateUpdate" />
            </div>
